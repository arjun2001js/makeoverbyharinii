...
const packages = [
  { number: '01', name: 'Skin Finish', items: ['Makeup', 'Hairstyle', 'Saree Draping', 'Lens & Lashes', 'Hair Extension'], description: 'Enhances your natural beauty with a fresh, radiant, skin-like glow. Seamless, luminous finish — elegant and timeless.', bestFor: ['Traditional weddings', 'Day ceremonies', 'Natural glow lovers'] },
  { number: '02', name: 'HD Makeup', items: ['Makeup', 'Hairdo', 'Saree Draping', 'Lens & Lashes', 'Hair Extension', 'Artificial Flowers'], featured: true, description: 'Flawless, smooth complexion perfect for photography & videography. Medium to full coverage, lightweight feel — lasts 12+ hours.', bestFor: ['Bridal weddings', 'Receptions', 'Photoshoots'] },
  { number: '03', name: 'Glossy/Glass Look', items: ['Makeup', 'Hairdo', 'Saree Draping', 'Lens & Lashes', 'Hair Extension', 'Artificial Flowers'], description: 'Luxurious glass-skin effect with intense hydration and luminous glow. Plump, fresh, radiant — trendy, editorial-inspired bridal look.', bestFor: ['Evening weddings', 'Reception looks', 'Fashion-forward brides'] },
]
